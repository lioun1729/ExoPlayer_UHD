...
public class SampleChooserActivity extends Activity {
  ...
  public void serverSettings() {
    ...
    AddURLBuilder.setPositiveButton("Configuration", new DialogInterface.OnClickListener() {
      ...
      public void onClick(DialogInterface dialog, int which) {
        ...
        //Toast.makeText(getApplicationContext(), "Set : " + Proxy_URL + ":" + Proxy_Port, Toast.LENGTH_SHORT).show();
    ...
    // getServerURL -> Playback Delay Cause

    //proxyAddress = getServerURL("ProxyURL");
    //proxyPort = getServerURL("ProxyPort");
  ...
  private abstract static class Sample {
    ...
    ////////// Build Intent for Information including Proxy Information //////////
    public Intent buildIntent(Context context) {
      ...
      intent.putExtra(PlayerActivity.PROXY_ADDRESS_EXTRA, proxyAddress);
      intent.putExtra(PlayerActivity.PROXY_PORT_EXTRA, proxyPort);
